...
module.exports={
    userinfo:function(name,nick,id,quest,ans,year,month,day){
        ...
        <tr>
            ...
            <td><input class="inputbox2" type="text" name="ans" id="ans" value="수정 시 볼 수 있습니다" style="font-style: italic; color:red" disabled ></td>
        </tr>
        <tr>
            <td>생년월일</label></td>
            <td>
                <input class="inputbox2" name="year" id="year" type="text" value="${year}" maxlength="4" style="width: 67px;" disabled>
                <input class="inputbox2" type="text" name="month" id="month" style="width:27px;" value="${month}" maxlength="2" disabled>
        ...
        <div style="text-align: center;">      
                <input class="click" type="button" id="modify" value="수정" onclick="Modify('${ans}');">
                <input class="inputbox2" type="password" id="pw" name="pw" placeholder="비밀번호" hidden>
                <p><input class="click" type="button" id="done" value="완료" hidden><p>
        </div> 
        </form>`
    },
